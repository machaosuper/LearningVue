...
const First_first = {template:'<div>First_first内容ffffffffff  {{$route.params.id}}</div>'}
...
const router = new VueRouter({
	...
	routes:[
		...
		{path:'/second', name:'second', component:Second, alias:['/alias','/gogo']},
		{path:'/aaa/:id', component:First_first},
  ...
  template: `
		<div id="nav">
			...
			<ol>
            	...
            	<li><router-link to="/aaa/12345">aaa</router-link></li>
            	<li><router-link to="/bbb/6789">bbb</router-link></li>
